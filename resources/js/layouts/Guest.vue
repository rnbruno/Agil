<template>
    <div class="min-h-screen bg-gray-100">
        <nav class="navbar navbar-expand-xl navbar-light text-center py-3 bg-white  ">
            <div class="container">
                                    ...
                                    <div class="row align-items-center">
                                        <div class="col-lg-5">
                                            <div class="section-title">
                                                ...
                                                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Consv allis
                                                    quam aliquet integer eget magna
                                                    ullam corper intesager vulutate aenean nunc quis a urna morbi id
                                                    vitae. Vulpuate nisl</p>
                                                <p>sed morbi sit ut placerat eges aeftas et. Pellen tesque tristisque
                                                    magnis augue gravida pulvinar
                                                    placerat. Tellus massa pretra scelerisque leo. In volutpat arcu nunc
                                                    nisl et, viverra faucisfbus</p>
                                                </p>
                                            </div>
                                        </div>
                                        <div class="col-lg-7 text-center text-lg-end">
                                            <img loading="lazy" decoding="async" :src="logoUrl_2" alt="About Ourselves"
                                                class="img-fluid">
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="row align-items-center justify-content-center">
                                        <div class="col-lg-6 mb-5 mb-lg-0">
                                            <div class="block text-center text-lg-start pe-0 pe-xl-5">
                                                <h1 class="text-capitalize mb-4">get a fastest loan with a smart way by
                                                    seating at home</h1>
                                                <p class="mb-4">We have collected the best offers of credit institutions
                                                    and banks
...
export default {
    ...
    data() {
        return {
            ...
            showDropdown: false,
            logoUrl_2: '/img/conceito-64871.jpg'
        }
    },
    components: {
        Navbar,
