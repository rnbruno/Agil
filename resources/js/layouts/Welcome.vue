                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="position-relative mb-4">
                                    ...
                                    <canvas id="visitors-chart" height="200" width="484"
...
export default {
    ...
    setup() {
        const { cotacoes, getCotacao, transferId, getTransfer } = useDashboard();
        ...
        return { user, cotacoes, getCotacao, transferId, getTransfer, idInt }
    },
    methods: {
